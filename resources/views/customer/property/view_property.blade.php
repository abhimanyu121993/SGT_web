    ...
    <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <a class="btn waves-effect waves-light breadcrumbs-btn right" href="#!" style="margin-right:70px;"><i
                        class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl"
                        style="color:black">Routes</span></a>

                <a class="btn waves-effect waves-light breadcrumbs-btn right" href="#!" style="margin-right:30px;"><i
                        class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl"
                        style="color:black;">QR MAP</span></a>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <i class="fa fa-user-circle" aria-hidden="true"
                                            style="float:right; margin-top:-46px;"></i>
                                    </div>
                    ...
                    <div class="col s12 m12 l6 ">
                        <div class="ct-chart card z-depth-2 border-radius-6 newBox">
                            <div class="card-content getjang">
                                ...
                                <h4 class="card-title langlang"><b>Total Checkpoint</b><br>CHECKPOINTS SUMMARY</h4>
                                <img style="float: right;
                margin-top: -46px;"
                                    src="{{ asset('app-assets/images/icon/claender.png') }}">
                            </div>
                            <div id="bar-chart-sample" class="center"
                    ...
                    <div class="col s12 m12 l6">
                        ...
                        <div class="card subscriber-list-card animate fadeRight  kangjang">
                            <div class="card-content pb-1 ">
                                <h4 class="card-title mb-0">Live tracking of guard<i
