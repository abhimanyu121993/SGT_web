        ...
        <div class="card-content">
                    ...
                    <div class="col l8">
                        <div class="row">
                            <div class="media display-flex align-items-center mb-2">
                                <a class="mr-2" href="#">
                                    <img src="../../../app-assets/images/avatar/avatar-11.png" alt="users avatar" class="z-depth-4 circle" height="70" width="70">
                                </a>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col m4">
                        <div class="col s12 m6 l12 card-width  ">
                            <div class="card border-radius-6 gradient-45deg-indigo-blue pt-5">
                                <p class="#212121 grey darken-4 center-align"><img class="hide-on-med-and-down" src="{{ asset('app-assets/images/logo/sgtlogo.jpeg') }}" alt="materialize logo" height="30px" width="50" /></p>
                                <div class="card-content ">
                                    <div class="row">
                                        <div class="col s6 "><img class="hide-on-med-and-down border-radius-6" src="../../../app-assets/images/avatar/avatar-11.png" alt="materialize logo" height="50px" width="50" /></div>
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                @endif                        
                        <div class="row">
                            <div class="col s4 input-field">
                                <input id="email" name="email" type="text" class="validate" value="{{ $guard->email ?? '' }}" data-error=".errorTxt2">
                                <label for="name">{{__('security_guard.login_id')}}</label>
                            </div>
                            <div class="col s4 input-field">
                                <input id="password" name="password" type="text" class="validate" value="" data-error=".errorTxt2">
                                <label for="name">{{__('security_guard.password')}}</label>
                            </div>

                                <div class="col s4 ">
                                    <input type="button" class="btn indigo" value="{{__('security_guard.change_password')}}" />
                                </div>
                        </div>
