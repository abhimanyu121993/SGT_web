...
@section('title', 'Security Guard')
@section('breadcrumb-title', 'Security Guard')
@section('breadcrumb-backpage', 'Security Guard')
@section('breadcrumb-currentpage', 'Security Guard')
    ...
    <div class="card">
        <div class="card-content">
            <div class="live-preview">
                <form
                    action="{{ isset($guard) ? route(Session::get('guard').'.secuirty-guard.update', $guard->id) : route(Session::get('guard').'.secuirty-guard.store') }}"
                        ...
                        <div class="file-field input-field col s12" id="image">
                            ...
                            <div class="input-group col s4">
                                <input type="password" class="form-control" id="password" name="password"
                                    value="{{ isset($guard) ? $guard->password : '' }}"
