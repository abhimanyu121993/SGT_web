...
@section('breadcrumb-currentpage', 'Translation Manager')
@section('link-area')
                ...
                <div class="form-group">
                    ...
                    <select name="group" id="group" class="form-control group-select">
                        @foreach ($groups as $key => $value)
                            <option value="{{ $key }}" {{ $key == $group ? ' selected' : '' }}>{{ $value }}
                            </option>
                        @endforeach
                    </select>
                </div>
    ...
    <form class="form-add-locale autotranslate-block-group hidden" method="POST" role="form"
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <p>
                    <code>If you would like to use Google Translate API, install tanmuhittin/laravel-google-translate and
