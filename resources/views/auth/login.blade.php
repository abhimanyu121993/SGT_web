...
{{-- <div id="login-page" class="row"> --}}
    {{-- <div class="col s12 m12 l12 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8"> --}}
        ...
        <div class="row  card-panel m-0 p-0" >
            <div class="row">
                <div class="col s1">
                    <img src="{{asset('app-assets/images/sgt/logo.png')}}" alt="" >
                </div>
            </div>
            <div class="row" style="display:flex; height:94vh; align-items: center">
            <div class="col m6 l4 s8">
                <form class="login-form" method="post" action="{{route('auth.'.$guard.'-login')}}">
                    <div class="row">
                        <div class="input-field col s12">
                            <h5 class="ml-4">Welcome Back !</h5>
                        </div>
                    </div>
