    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: Lato, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;text-align:center;">Congratulation <b></b> your registration is successfulled with SGT  Please visit link and create your password <b><a href="{{ $route['route'] }}">Create Password</a></b></p>
                        </td>
                    </tr>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: Lato, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">Regards to,<br>SGT TEAM</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#0769d9" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; color: #666666; font-family: Lato, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <h2 style="font-size: 20px; font-weight: 400; color: #fff; margin: 0;">SGT</h2>
                            <p style="margin: 0;"><a href="#" target="_blank" style="color: #FFF;font-size:12px;text-decoration:none;">Copyright © 2021 - 2023 SGT All Rights Reserved.</a></p>
                        </td>
                    </tr>
                </table>
            </td>
