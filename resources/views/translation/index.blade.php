...
@section('breadcrumb-title', 'Translation Manager')
@section('breadcrumb-backpage', 'Home')
@section('breadcrumb-currentpage', 'Translation')
@section('link-area')
        ...
        <div class="card">
            <div class="card-content">
                <p class="caption mb-0">
                    Warning, translations are not visible until they are exported back to the app/lang file, using <code>php
                        artisan translation:export</code> command or publish button.
                </p>
                ...
                @if (!isset($group))
                    <div class="row">
                        <form class="form-import" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postImport'); ?>" data-remote="true"  role="form">
                            ...
                            <div class="input-field col-6 s-6">
                ...
                <form role="form" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-field">
                            <select name="group" id="group" class="select2 browser-default">
            ...
            <div class="col-sm-12">
                    ...
                    <div class="card-content">
                        ...
                        <form action="{{ action('\Barryvdh\TranslationManager\Controller@postAdd', [$group]) }}"
                            ...
                            <div class="input-field col s12">
                                <label for="textarea2">Add new keys to this group</label>
                                <textarea class="materialize-textarea" rows="3" name="keys" id="textarea2"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p>
                                        <code>If you would like to use Google Translate API, install
                                            tanmuhittin/laravel-google-translate and enter your Google Translate API key to
                                            config file
                ...
                <fieldset>
                    ...
                    <form class="form-inline form-publish-all" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', '*'); ?>"
                        ...
                        @csrf
                        <button type="submit" class="btn btn-primary" data-disable-with="Publishing..">Publish
                            all</button>
                    </form>
                </fieldset>
        @endif
